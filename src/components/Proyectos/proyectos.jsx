				...
				<Container>
					...
					<Card style={{ width: '35rem', height: '45rem', border: 'none' }}>
						<Card.Body>
							...
							<Card.Text>
								...
								JavaScript puro. El juego tiene como objetivo ayudar al
								dinosaurio a saltar y evitar obstáculos.
							</Card.Text>
						</Card.Body>
					</Card>
					<Card style={{ width: '35rem', height: '45rem', border: 'none' }}>
					...
					<Card style={{ width: '35rem', height: '45rem', border: 'none' }}>
						<Card.Body>
							...
							<Card.Text>
								Este proyecto se desarrollo utilizando HTML, CSS y JavaScript.
								El objetivo principal de este proyecto es recrear una interfaz
								de usuario (sin funcionalidad). El proyecto es Responsive.
							</Card.Text>
						</Card.Body>
					</Card>
					<Card style={{ width: '35rem', height: '45rem', border: 'none' }}>
						<Card.Body>
							...
							<Card.Text>
								La app esta hecha con TypeScript y Angular 11: es una
								herramienta simple que permite a los usuarios administrar una
								lista de compras. Tiene aplicado un backend muy sencillo. De
								querer utilizarla se debe levantar localmente el servidor.
							</Card.Text>
						</Card.Body>
					</Card>
				</Container>
